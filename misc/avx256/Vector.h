...
public:
    ...
    inline Vector(double x, double y, double z)
            :mmvalue(_mm256_set_pd(0, z, y, x)) { }

    inline Vector(__m256d m)
            :mmvalue(m) { }
...
/// Arithmetic operators with Vector3
    inline Vector operator+(const Vector& b) const { return _mm256_add_pd(mmvalue, b.mmvalue); }

    inline Vector operator-(const Vector& b) const { return _mm256_sub_pd(mmvalue, b.mmvalue); }

    inline Vector operator*(const Vector& b) const { return _mm256_mul_pd(mmvalue, b.mmvalue); }

    inline Vector operator/(const Vector& b) const { return _mm256_div_pd(mmvalue, b.mmvalue); }
    ...
    inline Vector operator+(double b) const { return _mm256_add_pd(mmvalue, _mm256_set1_pd(b)); }

    inline Vector operator-(double b) const { return _mm256_sub_pd(mmvalue, _mm256_set1_pd(b)); }

    inline Vector operator*(double b) const { return _mm256_mul_pd(mmvalue, _mm256_set1_pd(b)); }

    inline Vector operator/(double b) const { return _mm256_div_pd(mmvalue, _mm256_set1_pd(b)); }
    ...
    inline Vector operator-() const { return _mm256_xor_pd(mmvalue, SIGNMASK); }
...
*/
inline Vector operator+(double a, const Vector& b) { return b+a; }

inline Vector operator-(double a, const Vector& b) { return Vector(_mm256_set1_pd(a))-b; }
