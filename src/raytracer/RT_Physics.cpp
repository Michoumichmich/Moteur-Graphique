...
Vector RT_Physics::computePhongIllumination(Vector p, Vector n, Vector ambientIntensity, std::list<Light> lights, ApparenceProperties properties) {
    /**
     * Ambient component
     */
     ...
     */
    Vector cameraDirection = (p - cameraPosition).normalize();
    ...
    for (it = lights.begin(); it != lights.end(); it++) {
        ...
        double specular = n.dot((lightDirection + cameraDirection).normalize());
